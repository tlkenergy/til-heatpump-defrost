...
model QdotDefrost_fail
  ...
  Modelica.Blocks.Sources.Ramp ramp(
    ...
    duration=10,
    offset=30,
    startTime=4000) annotation (Placement(transformation(extent={{-140,-32},{-128,-20}})));
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-160,
        ...
        coordinateSystem(preserveAspectRatio=false, extent={{-160,-120},{160,
          ...
          textString="With a 200 s delay for defrost, it goes into defrost when the temperature is increased because the evaporation pressure drops briefly.

If the delay is increased to 1000 s, this does not happen.")}),
    experiment(
      StopTime=6000,
      Tolerance=1e-05,
      __Dymola_Algorithm="Cvode"));
end QdotDefrost_fail;
